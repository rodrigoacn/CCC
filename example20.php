  ...
  <div class="container-fluid px-4" style="margin-top: 10em;">
    <div class="row">
      <div class="form-check col-12">
        <label for="inputTextoEjemplo" class="form-label">Título</label>
        <input type="text" class="form-control" id="inputTextoEjemplo" placeholder="Escribe el título de la clase.">
      </div>
    </div>
    <div class="row">
