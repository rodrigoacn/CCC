...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['temas'])) {
    csrf_require();
    $_SESSION['temas_tecnologia'] = array_slice((array)$_POST['temas'], 0, 5);
    ce_handle_subject_themes(10);
}
  ...
  <div class="container mt-10 pb-5">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active text-white"><?= t('tecnologia.breadcrumb_current') ?></li>
      </ol>
    </nav>

    <div class="d-flex align-items-center gap-3 mb-2">
      <img src="technology.png" alt="<?= t('tecnologia.alt_img') ?>" style="width:56px;height:56px;object-fit:cover;border-radius:.5rem;">
      <div>
        <h1 class="text-white mb-0"><?= t('tecnologia.title') ?></h1>
    ...
    <form method="POST" action="tecnologia.php" id="theme-form">
      ...
      <?php
        $sectionKeys = [
          'Digital Literacy, Hardware and Software Systems' => 'tecnologia.section_hardware',
          'Networks, Internet and Cybersecurity' => 'tecnologia.section_networks',
          'Algorithmic Thinking, Programming and Automation' => 'tecnologia.section_algorithms',
          'Technological Design, Projects and Social Impact' => 'tecnologia.section_design',
        ];
      ?>
      ...
      <div class="card bg-dark border-secondary mb-3">
        <div class="card-header border-secondary">
          <h6 class="text-secondary mb-0 text-uppercase" style="font-size:.75rem;letter-spacing:.08em;">
            <?= htmlspecialchars(t($sectionKeys[$caption] ?? $caption)) ?>
          </h6>
        </div>
